...
url = f"https://tr.wikipedia.org/wiki/Kategori:Türkiye%27deki_kültür_festivalleri"
...
for link in lis:
    try:
        ...
        dictionary["category"].append("Kültürel")
...
df.to_csv("kültürel.csv", index=False, encoding="utf-8-sig")
